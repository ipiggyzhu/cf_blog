...
homeCardSort:
description: Python脚本让复杂的数据处理和自动化任务变得简单优雅
---

# 🐍 Python脚本集合

> 💡 Python脚本让复杂的数据处理和自动化任务变得简单优雅
...
class PDFProcessor:
    ...
    def split_pdf(pdf_path, output_dir):
        ...
        print(f"分割完成，共 {len(reader.pages)} 页")
